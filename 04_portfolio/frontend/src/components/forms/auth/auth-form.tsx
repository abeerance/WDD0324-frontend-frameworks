 ...
 *
 * Client-side login form that handles user authentication.
 *
 * FLOW:
 * 1. User enters credentials
 * 2. React Hook Form validates with Zod schema
 * 3. On valid input, calls server action (loginAction)
 * 4. Server action communicates with Laravel API
 * 5. On success, redirects to dashboard
 * 6. On error, displays error message
 *
 * VALIDATION:
 * - Client-side: Zod schema via React Hook Form
 * - Server-side: Additional validation in loginAction
 */
