	...
	return (
		<button
			...
			className={cn(
				...
				variant === "primary" &&
					"bg-primary-700 text-background-10 hover:bg-primary-500 active:bg-primary-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500",

				// Secondary variant: Secondary actions
				// Dusty rose background - soft, approachable, warm
				variant === "secondary" &&
					"bg-secondary-600 text-background-10 hover:bg-secondary-500 active:bg-secondary-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary-500",

				// Accent variant: Attention-grabbing actions
				// Mustard yellow background - energetic, optimistic, highlights CTAs
				variant === "accent" &&
					"bg-accent-600 text-background-10 hover:bg-accent-500 active:bg-accent-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-500",
				...
				variant === "outline" &&
					"border-2 border-primary-500 text-primary-700 active:bg-primary-800 hover:bg-primary-500 hover:text-background-10 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500",
